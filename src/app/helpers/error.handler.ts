...
export class ErrorHandler {
    ...
    private setErrorMessage(errors: ValidationErrors) {
        if (errors.serverError) {
            ...
            this.message = 'Le champ est requis';
        } else if (errors.minlength) {
            this.message = `La longueur minimum est de ${errors.minlength.actualLength}/${errors.minlength.requiredLength}`;
        } else if (errors.maxlength) {
            this.message = `La longueur maximum est de ${errors.maxlength.actualLength}/${errors.maxlength.requiredLength}`;
        } else if (errors.email) {
            this.message = 'Email invalide';
        } else if (errors.min) {
            this.message = `La valeur minimum est de ${errors.min.min}, la valeur actuelle est de ${errors.min.actual}`;
        } else if (errors.max) {
            this.message = `La valeur maximum est de ${errors.max.max}, la valeur actuelle est de ${errors.max.actual}`;
        } else if (errors.pattern) {
            this.message = 'Valeur incorrecte';
